                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                        <div class="full">
                            <div class="center-desk">
                                <div class="logo">
                                    <a href="<?php echo e(url('/')); ?>">Gardge Point</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <nav class="navigation navbar navbar-expand-md navbar-dark">
                            ...
                            <div class="collapse navbar-collapse" id="navbarsExample04">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo e(url('/admin/dashboard')); ?>">Admin Dashboard</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo e(url('/admin/login')); ?>">Admin Login</a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
        ...
        <div class="footer">
         ...
         <div class="col-md-8">
            <ul class="location_icon">
               ...
               <li><a href="#"><i class="fa fa-volume-control-phone" aria-hidden="true"></i></a>0171210858</li>
               <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i></a>GardgePoint@gmail.com</li>
            </ul>
         </div>
           ...
           <div class="copyright">
              <div class="container">
                 <div class="row">
                    <div class="col-md-12">
                       <p>Copyright 2025 All Right Reserved By <a href="#">Hemel</a></p>
                    </div>
                 </div>
              </div>
           </div>
...
<?php /**PATH /Users/md.habibunnabihemel/Desktop/gardgePoint/resources/views/layouts/app.blade.php ENDPATH**/ ?>