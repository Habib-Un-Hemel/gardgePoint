...
<style>
   .banner_main {
      background: url('<?php echo e(asset('css/images/banner.jpg')); ?>') no-repeat center center;
      ...
      <div class="carousel-inner">
         <div class="carousel-item active">
            <div class="container text-center py-5">
               ...
               <a href="<?php echo e(url('/book-appointment')); ?>" class="btn btn-primary btn-lg mt-3">Book Now</a>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="row">
         <div class="col-md-4 mb-4">
            <div class="border p-3 text-center h-100">
               <img src="<?php echo e(asset('css/images/image1.png')); ?>" class="img-fluid mb-3" alt="Diagnostics">
               <h4>Diagnostics</h4>
         ...
         <div class="col-md-4 mb-4">
            <div class="border p-3 text-center h-100">
               <img src="<?php echo e(asset('css/images/image2.png')); ?>" class="img-fluid mb-3" alt="Repair">
               <h4>Repair</h4>
         ...
         <div class="col-md-4 mb-4">
            <div class="border p-3 text-center h-100">
               <img src="<?php echo e(asset('css/images/image.png')); ?>" class="img-fluid mb-3" alt="Maintenance">
               <h4>Maintenance</h4>
...
<section class="bg-light py-5">
   <div class="container">
      ...
      <div class="text-center mt-3">
         <a href="<?php echo e(url('/contact-admin')); ?>" class="btn btn-secondary btn-lg">Contact Us</a>
      </div>
   </div>
</section>
   ...
   <div class="container">
      ...
      <div class="row justify-content-center">
         <div class="col-md-6 text-center">
            <img src="<?php echo e(asset('css/images/tes3.jpg')); ?>" alt="Owner" class="rounded-circle img-fluid mb-3" style="width: 150px; height: 150px; object-fit: cover;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/md.habibunnabihemel/Desktop/gardgePoint/resources/views/landing.blade.php ENDPATH**/ ?>